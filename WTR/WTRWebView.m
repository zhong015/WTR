...
-(void)addHHObserver
{
    ...
    if(_isChangeHeight){
        ...
        //也和 box-sizing: border-box; 边框计算模式有关
        [self addUserScript:@"document.body.style.paddingTop='1px';var wtrStyle = document.createElement('style');wtrStyle.type = 'text/css';wtrStyle.textContent = `* {box-sizing: border-box;}`; document.head.appendChild(wtrStyle);" injectionTime:WKUserScriptInjectionTimeAtDocumentEnd forMainFrameOnly:NO];
