...
-(BOOL) UnzipFileTo:(NSString*) path overWrite:(BOOL) overwrite
{
	...
	do{
        ...
        NSString * strPath = [ZipArchive2 decodestr:fnameda];//[NSString stringWithUTF8String:filename];
