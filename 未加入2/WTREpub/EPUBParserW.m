...
@interface EPUBParserW()<ZipArchive2Delegate>

@end

@implementation EPUBParserW
...
//        GDataXMLDocument *opfXmlDoc = [[GDataXMLDocument alloc] initWithData:xmlData error:&err];
        GDataXMLDocument *opfXmlDoc=[[GDataXMLDocument alloc] initWithData:xmlData options:0 error:nil];
